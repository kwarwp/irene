...
class FioCruz:
    ...
    def __init__(self):
        ...
        self.ajuda = Elemento(FOCO, x=100, y=400, w=50, h=50, cena=self.fiocruz, style={"opacity": 0.5}, vai=self._ajuda)
        self.irProLab = Elemento(FOCO, x=500, y=400, cena=self.fiocruz, style={"opacity": 1})
