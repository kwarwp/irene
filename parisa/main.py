...
class FioCruz:
    ...
    def __init__(self):
        ...
        self.ajuda = Elemento(FOCO, x=30, y=350, width=50, height=50, cena=self.fiocruz, style={"opacity": 0}, vai=self._ajuda)
...
class LembrarHerdeitariedade:
    ...
    def __init__(self):
        ...
        self.ajuda = Elemento(FOCO, x=120, y=80, cena=self.lab, style={"opacity": 0.5}, vai=self._ajuda)
