...
class FioCruz:
    ...
    def __init__(self):
        ...
        self.ajuda = Elemento(FOCO, x=50, y=350, w=50, h=50, cena=self.fiocruz, style={"opacity": 0.5}, vai=self._ajuda)
        self.irProLab = Elemento(FOCO, x=700, y=500, cena=self.fiocruz, style={"opacity": 1})
