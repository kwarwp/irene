...
'''},
{'date': 'Tue Nov 05 2019 12:39:13.520 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module _spy.vitollino.main line 977
    self._cria_divs(width)
  module _spy.vitollino.main line 982
...
SyntaxError: invalid syntax
'''},
{'date': 'Tue Nov 05 2019 14:15:23.459 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
AttributeError: 'module' object has no attribute 'update'
'''},
{'date': 'Tue Nov 05 2019 14:15:34.242 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module _core.supygirls_factory line 295
    exec(self.code, glob)  # dict(__name__="__main__"))
  module <module> line 7
    STYLE.update(width=850, height=650)
AttributeError: 'module' object has no attribute 'update'
'''},
{'date': 'Tue Nov 05 2019 14:16:33.130 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 23
    fc = FioCruz()
  module <module> line 13
    self.fc = Cena(FIOFRONTdireita=self)
  module _spy.vitollino.main line 975
    Cena.c(**kwargs)
  module _spy.vitollino.main line 1018
...
'''},
{'date': 'Sat Nov 09 2019 11:26:36.10 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
SyntaxError: invalid syntax
'''},
{'date': 'Sat Nov 09 2019 13:11:00.602 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
AttributeError: 'LembrarHerdeitariedade' object has no attribute 'ajuda'
'''},