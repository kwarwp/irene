...
class LembrarHerdeitariedade:
    ...
    def __init__(self):
        ...
        self.maria = Elemento(FOCO, x=630, y=180, cena=self.lab, style={"opacity": 1},vai=self._ajuda2_2)
        self.joana = Elemento(FOCO, x=700, y=180, cena=self.lab, style={"opacity": 1},vai=self._ajudajoana)
