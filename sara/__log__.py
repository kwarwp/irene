...
IndentationError: unexpected indent
'''},
{'date': 'Mon Nov 11 2019 10:51:45.874 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
 module <string> line 37
  def __init__(self):
  ^
IndentationError: unexpected indent
'''},
{'date': 'Mon Nov 11 2019 10:52:12.289 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
 module <string> line 37
  def __init__(self):
  ^
...
IndentationError: unexpected indent
'''},
{'date': 'Mon Nov 11 2019 10:58:20.754 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
 module <string> line 37
  def __init__(self):
  ^
IndentationError: unexpected indent
'''},
{'date': 'Mon Nov 11 2019 10:59:07.482 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
'''},
{'date': 'Mon Nov 11 2019 11:00:23.364 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 57
    self.fiocruz.vai()
AttributeError: 'LembrarHereditariedade' object has no attribute 'fiocruz'
'''},