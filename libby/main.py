...
class LembrarHerdeitariedade:
    ...
    def __init__(self):
        ...
        self.ajuda = Elemento(FOCO, x=130, y=100, cena=self.lab,
             style={"opacity": 0},vai=self._ajuda)
        self.denise = Elemento(FOCO, x=230, y=100, cena=self.lab,
             style={"opacity": 1})

    def _ajuda(self, _=0):
        """O personagem dá uma explicação de como encrontrar a fórmula """
    ...
    def _ajuda5_1(self, _=0):
        """O personagem dá uma nova explicação de como encrontrar a fórmula """
