...
class LembrarHerdeitariedade:
    ...
    def __init__(self):
        ...
        self.denise = Elemento(FOCO, x=260, y=140, cena=self.lab,
             style={"opacity": 0})
        self.caneca = Elemento(CANECA, x=740, y=260, w=40, h=40, cena=self.lab,
             style={"opacity": 1})
...
class Escritorio:
    ...
    def __init__(self):
        ...
        self.cofre = Elemento(COFRE, x=740, y=260, w=40, h=40, cena=self.esc,
             style={"opacity": 1})
    def vai(self):
        """O jogo inicia aqui. O laboratório será apresentado """
        self.esc.vai()
        Texto(self.esc, "Temos que achar a fórmula. Vamos perguntar a alguém").vai()
        
    
if __name__ == "__main__":
    fc = Escritorio() #FioCruz()
    fc.inicia()
#####################################################################################################
